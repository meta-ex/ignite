...
(grumble [:head grumble-g] :freq-mul 2 :out-bus ob :amp 1)
(grumble [:head grumble-g] :freq-mul 1.8 :out-bus ob :amp 1)
(grumble [:head grumble-g] :freq-mul 1.5 :out-bus ob :amp 1)
