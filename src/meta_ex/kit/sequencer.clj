...
(defn- start-synths [samples mixers num-steps tgt-group beat-cnt-bus beat-trg-bus out-bus]
...
(defn mk-sequencer
  ...
  ([handle samples num-steps tgt-group beat-trg-bus beat-cnt-bus out-bus with-mixers?]
     (let [desc            (str "M-x Sequencer " handle)
           ...
           synths          (start-synths samples mixers num-steps seq-group beat-cnt-bus beat-trg-bus out-bus)]
